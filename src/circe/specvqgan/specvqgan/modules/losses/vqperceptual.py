...
from circe.specvqgan.specvqgan.modules.discriminator.model import (NLayerDiscriminator, NLayerDiscriminator1dFeats,
                                                   NLayerDiscriminator1dSpecs,
                                                   weights_init)
from circe.specvqgan.specvqgan.modules.losses.lpaps import LPAPS
...
class VQLPAPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        print("Instantiating VQLPAPSWithDiscriminator")
        super().__init__()
